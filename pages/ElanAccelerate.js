        ...
        <div className="  ">
          ...
          <div className="mt-7 ">
            ...
            <div className="m-4  mt-7 flex flex-wrap items-center justify-center g-2 mt-7">
              ...
              <div className="w-1/3 pr-5 text-center">
                <div className=" rounded-lg shadow-lg p-6  mb-4 ">
                  <Image className="w-72" src={ElanAcce2} alt="Logo" />
              ...
              <div className="  w-1/3 pr-5 text-center">
                <div className=" rounded-lg shadow-lg p-6  mb-4 ">
                  <Image className="w-72" src={ElanAcce3} alt="Logo" />
          ...
          >
            ...
            <div className="mt-9 flex justify-between gap-2">
              <div className="w-1/3 pr-5">
                <p
                  className="text-3xl font-bold transform rotate-360 inline-block"
                  style={{
              ...
              <div className=" w-2/3 pr-5">
                <Image className="w-full " src={ElanAcceimg} alt="elanacce" />
              </div>
              <div className="w-1/3 pr-5">
                <div>
      ...
      <div className="bg-[#9296F0] mt-9">
        <div className="border-b-2 border-gray-500 px-4 py-8 flex flex-col md:flex-row md:justify-between md:items-center">
          <div className="flex items-center mb-4 md:mb-0">
            ...
            <GrBusinessService className="text-4xl mr-4" />
          </div>
        </div>
        <div className="border-b-2 border-gray-500 px-4 py-8 flex flex-col md:flex-row md:justify-between md:items-center">
