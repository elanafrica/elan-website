      ...
      <div className="m-4">
        ...
        <div className="mt-9 mb-7">
          <div className="mt-9 flex justify-center flex-wrap gap-4 ">
            <Image className="w-32" src={Elanstudcard1} alt="elandevcard1" />
            <Image className="w-32" src={Elanstudcard2} alt="elandevcard2" />
            <Image className="w-32" src={Elanstudcard3} alt="elandevcard3" />
            <Image className="w-32" src={Elanstudcard4} alt="elandevcard4" />
            <Image className="w-32" src={Elanstudcard5} alt="elandevcard1" />
            <Image className="w-32" src={Elanstudcard6} alt="elandevcard2" />
            <Image className="w-32" src={Elanstudcard7} alt="elandevcard3" />
            <Image className="w-32" src={Elanstudcard8} alt="elandevcard4" />
          </div>
        </div>
        ...
        <div className="bg-[#151414] p-4 text-white">
          ...
          <div className="m-4  mt-7 flex flex-wrap items-center justify-center ">
            ...
            <div className=" mt-9 w-1/3 pr-5">
              <Image className="w-full homepage22" src={Elanstud4} alt="Logo" />
            </div>
          </div>
        </div>
      </div>
