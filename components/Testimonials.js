        ...
        <section>
          ...
          <div className="testimonialTrack grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 p-5 gap-6">
            <div className="h-full text-center text-white ml-5 p-5 bg-[rgb(7,39,78)] rounded-lg cursor-pointer hover:rotate-1">
              <Image className="h-24 w-24 object-cover rounded-full inline-block bg-opacity-10 items-center justify-center" src={testimonial} alt="testimonial profile" />
            ...
            <div className="h-full text-center text-white ml-5 p-5 bg-[rgb(7,39,78)] rounded-lg cursor-pointer hover:rotate-1">
              ...
              <span className="inline-flex h-1 w-14 rounded bg-[rgb(7,39,78)] mt-4 mb-2"></span>
              <h2 className="title-font font-bold text-lg tracking-wider">John Doe</h2>
              <p clasName="text-sm text-gray-500">Brand Marketer</p>
            </div>
          </div>     
        </section>
